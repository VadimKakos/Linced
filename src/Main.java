...
public class Main {
    private static final List<String> NAMES = List.of("Ян Янович", "Петр Петрович", "Дмитрий Дмитриевич", "Денис Денисович", "Валерий Валереевич", "Олег Олегович", "Стас Станиславович", "Лев львович", "Женя Евгениевич");
